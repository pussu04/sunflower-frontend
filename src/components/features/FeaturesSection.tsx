    ...
    <section className="container px-4 py-24">
      ...
      <div className="max-w-2xl mb-20">
        <h2 className="text-5xl md:text-6xl font-normal mb-6 tracking-tight text-left">
          AI-Powered Disease
          <br />
          <span className="text-gradient font-medium">Detection Tools</span>
        </h2>
        <p className="text-lg md:text-xl text-muted-foreground text-left">
          Advanced machine learning technology designed to help farmers identify and treat sunflower diseases early and effectively.
        </p>
      </div>
